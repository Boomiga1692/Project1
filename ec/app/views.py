...
class checkout(View):
    def get(self,request):
        ...
        #{'id': 'order_LWxg7HbYgZBTh9', 'entity': 'order', 'amount': 160500, 'amount_paid': 0, 'amount_due': 160500, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1680010268}
